...
public:
  ...
  //jtbao
  bool plannerServiceCallbackNew(dsvplanner::dsvplanner_srv::Request& req, dsvplanner::dsvplanner_srv::Response& res);
...
private:
  ...
  //jtbao
  //std::queue<Vector3d> path_cluster_centroids_;
  std::vector<StateVec> local_tsp_visits_;
  int retry_cnt_ = 0;
  bool last_exploration_stage_;
};
}
